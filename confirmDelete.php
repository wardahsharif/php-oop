...
<div class="container border rounded p-4 confirmation">
    ...
    <form action="confirmDelete.php?id=<?php echo $product_id; ?>" method="POST">
        <div class="form-input btn rounded btn-delete">
     <a href='delete.php?id=<?php echo $product_id; ?>'>Yes, Delete</a> | <a href='admin_dashboard.php?id=products'>No, Cancel</a></div>
        </div>
    </form>
</div>
