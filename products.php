...
<body>
<div>
    <button><a href="upload_product.php">Upload Product</a></button>
</div>
</body>
</html>
  <div class="row">
                    ...
                    <div class='card my-3 '>
                       <img src='uploads/" . $row['product_image'] . "' class='card-img-top' alt='Product Image''>
                        ...
                        <div class='card-body text-center'>
                            ...
                            <a href='edit.php?productid=" . $row['id'] . "' class='btn edit-delete'>Edit</a>
                            <a href='confirmDelete.php?id=" . $row['id'] . "' class='btn edit-delete'>Delete</a>
                        </div>
                    </div>
                </div>";
        }
